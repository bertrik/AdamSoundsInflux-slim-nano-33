...
// char arrays include room for \0 termination, effictively the string is 1 character shorter!
...
#define HTTP_REQ_PARAM_NAME_LENGTH 12 //adjust to meet your needs
#define HTTP_REQ_PARAM_VALUE_LENGTH 32  //adjust to meet your needs
...
#define HTTP_REQ_EVENT_PARAM 1
#define HTTP_REQ_CALLBACK void (*callback)(int, char*, char*)
...
{  
  ...
  void setCallback(HTTP_REQ_CALLBACK);
