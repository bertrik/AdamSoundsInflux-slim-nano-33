...
//        Serial.write(c); // echo everything coming in to serial (debug)
        ...
        if (httpReq.endOfRequest()) {
          ...
          else if(String(httpReq.method) == "GET" && String(httpReq.uri) == "/asokit.svg") {
          ...
          else if(String(httpReq.method) == "GET" && String(httpReq.uri) == "/script.js") {
          ...
          else if(String(httpReq.method) == "GET" && String(httpReq.uri) == "/icon.gif") {
          ...
          else if(String(httpReq.method) == "POST" && String(httpReq.uri) == F("/values")) {
